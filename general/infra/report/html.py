"""HTML report: infra report with images and findings only (rule_id starting with prefix)."""
...
def write_html(
    ...
    title = opts.get("report_title") or "RootCause Infra Report"
    buf = io.StringIO()
    ...
    buf.write("</body></html>")
    path = os.path.join(report_dir, "infra-report.html")
